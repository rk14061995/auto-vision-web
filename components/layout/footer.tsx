...
import { trackFooterLinkClick, trackLogoClick } from "@/lib/gtag"
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-5">
          ...
          <div className="space-y-4 md:col-span-1">
            <Link href="/" title="AutoVision Pro home" onClick={() => trackLogoClick("footer")} className="flex items-center gap-2">
            ...
            <a
              ...
              onClick={() => trackFooterLinkClick("contact", "Email Support")}
                ...
                {footerLinks[col].map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      title={link.title}
                      onClick={() => trackFooterLinkClick(col, link.name)}
          ...
          <div className="flex gap-5 text-xs text-gray-400">
            {[
              ...
              <Link
                ...
                href={l.href}
                title={l.title}
                onClick={() => trackFooterLinkClick("bottom_bar", l.name)}
